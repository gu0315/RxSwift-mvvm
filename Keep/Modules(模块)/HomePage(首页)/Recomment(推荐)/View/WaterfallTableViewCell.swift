...
import Foundation
import YYText
class WaterfallTableViewCell: UITableViewCell {
    ...
    public var item: HomeRecommentItem? {
        didSet {
            ...
            headView.author = item.recommendEntry?.author
...
//        //在进行后台渲染前是否清除掉之前的内容，如果YES就会先清除之前的内容，可能会出现空白
