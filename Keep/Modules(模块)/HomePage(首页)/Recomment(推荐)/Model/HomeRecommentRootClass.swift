...
class HomeRecommentRootClass : NSObject, NSCoding, Mappable{

	var data : HomeRecommentData?
	var errorCode : Int?
	var now : String?
	var ok : Bool?
	var text : String?
    ...
    */
	...
	{
         data = aDecoder.decodeObject(forKey: "data") as? HomeRecommentData
