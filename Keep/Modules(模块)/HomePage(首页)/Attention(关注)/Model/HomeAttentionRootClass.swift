...
class HomeAttentionRootClass : NSObject, NSCoding, Mappable{

	var data : HomeAttentionData?
	var errorCode : Int?
	var now : String?
	var ok : Bool?
	var text : String?
    ...
    */
	...
	{
         data = aDecoder.decodeObject(forKey: "data") as? HomeAttentionData
